...
FINAL_IMPROVEMENT_AGENT_PROMPT = os.path.join(CONFIG_DIR,'final_improvement_agent_prompt.yaml')
JOB_ANALYZER_AGENT_PROMPT = os.path.join(CONFIG_DIR,'job_analyzer_prompt.yaml')
RESUME_IMPROVEMENT_AGENT_PROMPT = os.path.join(CONFIG_DIR,'resume_improvement_agent_prompt.yaml')
